                    ...
                    <div class="col-10">
                        ...
                        <div class="invoice p-3 mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
                                        ...
                                        <br>+62 878 2042 5551 atau <a
                                            href="https://wa.me/6287820425551?text=Halo%20saya%20ingin%20mengkonfirmasi%20pembayaran%20Fidyah%20atas%20nama%20{{ $fidyah->nama }}%20dengan%20nominal%20Rp%20{{ $fidyah->nominal }}%20yang%20sudah%20saya%20transfer%20pada%20{{ Carbon\Carbon::parse($fidyah->created_at)->format('d-m-Y') }}."
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    <a href="{{ route('fidyah.user') }}" class="btn btn-primary"><i
                                            class="fas fa-arrow-left"></i> Kembali</a>
                                    <a href="{{ route('fidyah.print', ['id' => $fidyah->id]) }}" rel="noopener"
