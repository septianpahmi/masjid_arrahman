                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <select id="id_kategori" name="id_kategori"
                                ...
                                required>
                                <option selected value="">Pilih Zakat</option>
                                @foreach ($kat as $k)
                        ...
                        <div class="mt-5">
                            <h4 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Lengkapi
                                data di
                                bawah ini:</h4>
                        </div>
                        <div class="col-6">
