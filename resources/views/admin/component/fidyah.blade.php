                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Tabel Fidyah</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                                    ...
                                                    @if ($k->status == 'Pending')
                                                        ...
                                                        <div class="dropdown-menu" role="menu">
                                                            <a class="dropdown-item status"
                                                                data-id="{{ $k->id }}"
                                                                url="{{ url('/report-fidyah/approve', $k->id) }}">Terima</a>
                                                            <a class="dropdown-item status"
                                                                data-id="{{ $k->id }}"
                                                                url="{{ url('/report-fidyah/reject', $k->id) }}">Tolak</a>
                                                        </div>
                                                    @endif
                                                    <div class="btn-group btn-block">

                                                        <button url="{{ route('fidyah.delete', $k->id) }}"
